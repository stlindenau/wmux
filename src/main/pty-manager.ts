...
function buildShellArgs(
  ...
  if (shellType === 'wsl') {
    ...
    // WMUX_UNIX_SOCKET needs /up to translate Windows path to WSL mount path.
    const wmuxWslEnv =
      'WMUX/u:WMUX_SURFACE_ID/u:WMUX_CLI/up:WMUX_PIPE/u:WMUX_PIPE_TOKEN/u:WMUX_UNIX_SOCKET/up:WMUX_INTEGRATION/u';
